package com.example.springeurekaclientschoolservice.util;
	...
	public void contribute(Info.Builder builder) {
		builder.withDetail("details",
				...
				Collections.singletonMap("description",
						"This is the School service, which is discovery server aware," +
								" and this service will Call Student Microservice," +
								" fro student details, which is again dicovery server aware!!! "));
	}
